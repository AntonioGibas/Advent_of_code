...
U dijelu koda koji se izvršava kada je zastavica `VALIDAN` postavljena na `'0'b` (false), program sortira redoslijed stranica prema zadanim pravilima. 
...
Algoritam koji se koristi za sortiranje nevalidnog niza jest varijanta bubble sort algoritma, ali prilagođenog specifičnim pravilima:
